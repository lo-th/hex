// https://github.com/Wu-Yijun/lzma-wasm
import { initWasm, initWasmSync, compress, decompress } from './lzma-wasm.js'
...
class Menu {
    ...
    saveFile () {
        ...
        Files.save({ data:this.result, name:name, type:'bin' })
    ...
    addGithubLink () {
        ...
        var icon_Github = [
            ...
            "<path d='M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z' id='octo' onmouseover='window.unpack.Gover();' onmouseout='window.unpack.Gout();' onmousedown='window.unpack.Gdown();' style='cursor:pointer; pointer-events:auto;'></path>",
